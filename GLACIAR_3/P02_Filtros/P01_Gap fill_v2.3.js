...
var OutputAsset = "projects/mapbiomas-raisg/TRANSVERSALES/GLACIAR_3/clasificacion-ft/"
var OutputAssetMet = 'projects/mapbiomas-raisg/TRANSVERSALES/GLACIAR_3/metadata/'
...
years.forEach(function(year){
  var GlacierYear = Clasificacion_Year.filterMetadata('year', 'equals', year);
  Clasificacion = Clasificacion.addBands(GlacierYear.mosaic().rename('classification_'+year));
});
