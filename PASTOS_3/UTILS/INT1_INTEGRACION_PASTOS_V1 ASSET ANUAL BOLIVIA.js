...
var dirinput = 'projects/mapbiomas-raisg/TRANSVERSALES/PASTOS_3/clasificacion-ft'
var dirout = 'projects/mapbiomas-raisg/TRANSVERSALES/PASTOS_3/INTEGRACION/PASTOS3'
...
bandnamelist.forEach(function(bandname){
       var integracion_year = ee.Image(27).where(integracion_v0.select(bandname).eq(1), 15)
