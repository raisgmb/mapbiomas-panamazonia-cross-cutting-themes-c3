var param = { 
  input: 'MINERIA-703-PERU-ANDES-CENTRO-2',
...
var collection = param.inputCollection;
...
// input collection
var image = ee.Image('projects/mapbiomas-raisg/TRANSVERSALES/MINERIA_3/' + collection + '/' + input);
