...
var param = {
  ...
  exclusion : {
    ...
    polygons: [ natural86, natural87, geometry ],
...
(function init(param) {
  ...
  var assets = {
    ...
    image:'projects/mapbiomas-raisg/COLECCION3/clasificacion-ft'
  };
  ...
  assets.image = assets.image+'/'+country+'-'+regionId+'-'+param.versioninput
    var image = ee.Image(assets.image).updateMask(fullRegion);
