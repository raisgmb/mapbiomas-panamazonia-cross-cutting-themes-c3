var param = {
    ...
    pais: 'BOLIVIA', 
    year: [2000,2015],  // Solo visualizacion
    // ciclo: 'ciclo-1',
    version_input:4, // 
    version_output:5,// 
...
var ordem_exec_first =  [1, 2];              //Filtro de primer año
var ordem_exec_last =   [1];                               //Filtro de ultimo año
var ordem_exec_middle = [2];  //Filtro de años intermedios
...
if (param.VerSoloclaseAgri>0){
      img = img.mask(img.eq(1))
      fil = fil.mask(fil.eq(1))
    }
Map.addLayer(img, vis, 'original'+param.year[yearI],false);

Map.addLayer(fil, vis, 'filtered'+param.year[yearI],false);
}
