...
var dirinput = 'projects/mapbiomas-raisg/TRANSVERSALES/AGRICULTURA_3/clasificacion-ft'
var dirout = 'projects/mapbiomas-raisg/TRANSVERSALES/AGRICULTURA_3/INTEGRACION/AGRICULTURA3'
...
bandnamelist.forEach(function(bandname){
       var integracion_year = ee.Image(27).where(integracion_v0.select(bandname).eq(1), 21)
