...
var param = {
    ...
    version_input: '1',
    version_output: '2',
    metodo: 'Arbol de desicion' //Random forest - Arbol de desicion
...
var met;
if(param.metodo == 'Arbol de desicion'){
   met = 'DT';
  } else if (param.metodo =='Random forest') {
   met = 'RF';
}
...
*/
var imageName = param.pais + '-' + param.code_region + '-' + met + '-'+ version_output;
...
var imageNameGapFill = param.pais + '-' + param.code_region + '-' + met + '-' + version_output + '-metadata';
