 ...
 * ndwi_mcfeeters_6_2
**/
// YEAR, ndwi_mcfeeters_4_1, ndwi_mcfeeters_6_1, ndwi_mcfeeters_6_2
                  // Year    4-1   6-1     6-2
var YearsParam =  [
                    [1985,   120,   60,    102], 
                    [1986,   120,   60,    102], 
...
YearsParam.forEach(function(parametro){
  ...
  var tree = {
    ...
    ndwi_mcfeeters_6_1:parametro[2],  //mayor o igual a (aprox 60 en andes, para Amazonia aprox 40)
    ndwi_mcfeeters_6_2:parametro[3]  //mayor o igual a    // Recomendado solo para ANDES
  }
