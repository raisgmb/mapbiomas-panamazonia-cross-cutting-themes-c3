...
var param = {
    carta : 'SA-17-Z-D',
    code_region: 40102,  //Region de Clasificacion
...
var tree = {
  ...
  ndwi_mcfeeters_6_1:30,  //mayor o igual a (aprox 60 en andes, para Amazonia aprox 30)
  ndwi_mcfeeters_6_2:102,  //mayor o igual a    // Recomendado solo para ANDES
  
  mndwi_median_70_2:30,  //mayor o igual a (aprox 60 en andes, para Amazonia aprox 30)
  mndwi_median_70_4:102,  //mayor o igual a    // Recomendado solo para ANDES
  
  ndvi_median_80_2:165, // menor o igual a 128 en andes en amazonia valores mas altos de ndvi
  ndvi_median_80_4:128, // menor o igual a 128 en andes en amazonia valores mas altos de ndvi
}
...
// Reference Map
var water = classif_col2.eq(33).reduce('sum').gte(33).multiply(33);
var otros = classif_col2.neq(33).reduce('sum').gte(33).multiply(27);
